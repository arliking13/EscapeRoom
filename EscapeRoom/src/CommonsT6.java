...
public class CommonsT6 extends JPanel{
	...
	public CommonsT6(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("The Escape Room");            // NOTE: change XY to student's initials
		frame.getContentPane().add(new CommonsT6(create_Scene()));  // create an instance of the class
